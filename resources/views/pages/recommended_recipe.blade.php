...
================================================== -->
    ...
    <div class="container">
        ...
        <!-- Headline -->
        <div class="sixteen columns">
            <h3 class="headline">Recommended Recipes based on Categories of Recipes you loved </h3>
            <span class="line margin-bottom-35"></span>
            <div class="clearfix"></div>
        </div>
        <div class="clearfix"></div>
        ...
        @foreach($recipes_with_same_category_i_like as $recipeId)
        ...
        <!-- Headline -->
        <div class="sixteen columns">
            <h3 class="headline">Users who loved your Recipes also loved </h3>
            <span class="line margin-bottom-35"></span>
            <div class="clearfix"></div>
        </div>
        <div class="clearfix"></div>
        ...
        @foreach($recipe_other_users_liked_id as $recipeId)
        ...
        @foreach($recipe_based_on_user_preference_active as $recipeId)
